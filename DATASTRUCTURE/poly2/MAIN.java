...
public class MAIN {
	...
	public static void main(String[] args) {
		...
		System.out.print("Poly 1 : "); poly1.printResult();
		...
		System.out.print("Poly 2 : "); poly2.printResult();
		
		System.out.print("Poly 1 * 2x^0 = ");
		poly1.sMult(2, 0).printResult();

		System.out.print("Poly 1 * 2x^1 = ");
		poly1.sMult(2, 1).printResult();
		
		System.out.print("Poly 1 + Poly2 = ");
