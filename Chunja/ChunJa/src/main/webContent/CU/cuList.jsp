...
<body style="overflow-x: hidden">
    ...
    <table class="title-back">
        ...
        <td style=" width:760px; height: 260px; text-align: right; font-family: 'CJFONT'; color: #FFF3FD;">
    ...
    <div style="text-align:center;">
        <form action="cuSearch.jsp" method="post">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b class="s2" onclick="location.href='cuRank.jsp'">춘자 랭킹</b>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <b class="s1" onclick="location.href='cuList.jsp'">춘자 가게들</b>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
