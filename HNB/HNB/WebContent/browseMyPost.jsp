    ...
    <div id="main-forum"> 
        ...
        <div id="create-content-box">
            ...
            <div id="button-box">
                ...
                <button id="submit" onclick="location.href='delete.do?bId=${bdto.bNum}'">
                    삭제</button>

                        
                <button id="submit" onclick="location.href='modify_view.do?bId=${bdto.bNum}'">
                    수정</button>
